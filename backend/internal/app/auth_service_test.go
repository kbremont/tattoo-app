...
func TestSignUp(t *testing.T) {
	tests := []struct {
		name      string
		setupMock func(repo *mockAuthRepo)
		expectErr bool
	}{
		{
...
func TestLogIn(t *testing.T) {
	tests := []struct {
		...
		mockEmail  string
		mockPass   string
		setupMock  func(repo *mockAuthRepo, hash string, userID uuid.UUID)
		expectErr  bool
		expectUser bool
	}{
		{
...
func TestRefreshToken(t *testing.T) {
	tests := []struct {
		name      string
		setupMock func(repo *mockAuthRepo, userID uuid.UUID)
		expectErr bool
	}{
		{
			name: "valid refresh",
